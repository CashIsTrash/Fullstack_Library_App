package se.ecutb.fullstack_lib.controller;
...
import se.ecutb.fullstack_lib.dto.UpdateAppUserFormDto;
...
import se.ecutb.fullstack_lib.service.AppUserService;
...
public class AppUserController {
    ...
    // A failure leads to access-denied, but should be "deletion failed", that doesn't exist at the moment
