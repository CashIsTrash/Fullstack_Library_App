package se.ecutb.fullstack_lib.constants.messages;

public class ValidationMessages {
    public static final String USERNAME_FORMAT_MESSAGE = "Specified username is not valid - Must be between 3 and 15 characters, all lower case, and not include @";
    public static final String FIELD_REQUIRED_MESSAGE = "Field is required";
    ...
    public static final String DATE_PATTERN_MESSAGE = "Enter date as XXXX-XX-XX";
